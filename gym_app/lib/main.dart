...
import 'package:gym_app/pages/bmi_calculator_page.dart';
import 'package:gym_app/pages/exercise_detail_page.dart';
import 'package:gym_app/pages/exercise_list_page.dart';
import 'package:gym_app/pages/filter_page.dart';
import 'package:gym_app/pages/my_home_page.dart';
...
class _MyAppState extends State<MyApp> {
  _toggleIsFavourite(ExerciseModel exerciseModel) {
    ExerciseModel model = exerciseList.firstWhere(
    ...
    return MaterialApp(
      ...
      theme: ThemeData(
        ...
        inputDecorationTheme: InputDecorationTheme(
          ...
          labelStyle: const TextStyle(color: Color(0xFF322751)),
