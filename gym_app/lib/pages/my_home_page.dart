...
import 'package:gym_app/widgets/exericse_card_widget.dart';
import 'package:gym_app/widgets/workout_category_widget.dart';
            ...
            _index == 0
                ? Expanded(
                  child: ListView.builder(
                    ...
                    itemBuilder:
                        (context, index) => WorkoutCategoryWidget(
                ...
                : Expanded(
                  child: ListView.separated(
                    ...
                    itemBuilder:
                        (context, index) => ExerciseCardWidget(
                          exerciseModel:
                              exerciseList
                                  .where((element) => element.isFavourite)
                                  .toList()[index],
