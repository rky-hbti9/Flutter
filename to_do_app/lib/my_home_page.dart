...
import 'package:to_do_app/data.dart';
import 'package:to_do_app/new_task_page.dart';
import 'package:to_do_app/todo_card_widget.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ListView(
        children:
            _tempListOfTodo
                .map((e) => TodoCardWidget(todoModel: e, update: updateStatus))
                .toList(),
      ),
    );
  }
